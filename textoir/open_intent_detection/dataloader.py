...
class Data:
    ...
    def __init__(self, args):
        ...
        self.train_examples, self.unlabeled_examples = self.get_examples(processor, args, 'train')
        self.eval_examples = self.get_examples(processor, args, 'eval')
        self.test_examples = self.get_examples(processor, args, 'test')
        
        self.train_dataloader = self.get_loader(self.train_examples, args, self.label_list, 'train')
        self.eval_dataloader = self.get_loader(self.eval_examples, args, self.label_list, 'eval')
        self.test_dataloader = self.get_loader(self.test_examples, args, self.label_list, 'test')
        self.unlabeled_dataloader = self.get_loader(self.unlabeled_examples, args, self.label_list, 'unlabeled')
    ...
    def get_loader(self, examples, args, label_list, mode = 'train'):
        ...
        elif mode == 'eval' or mode == 'test' or mode == 'unlabeled':
